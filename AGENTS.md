...
4. [MASTER_ROADMAP.md](MASTER_ROADMAP.md) — detailed checkpoint route and proof gates.
5. [CURRENT_STATE.json](CURRENT_STATE.json) — authoritative implementation and evidence state.
6. [ARCHITECTURE.md](ARCHITECTURE.md) — technical ownership boundaries.
7. [MODEL_STRATEGY.md](MODEL_STRATEGY.md) — cognition and model constraints.
8. [SECURITY_MODEL.md](SECURITY_MODEL.md) — authorization, privacy, and completion guarantees.
9. [PACK_SPEC.md](PACK_SPEC.md) — Pack contracts and extensibility.
10. [docs/OWNER_DOGFOOD.md](docs/OWNER_DOGFOOD.md) — installed-runtime behavior evidence.

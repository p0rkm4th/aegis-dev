...
| [cytoscape/cytoscape.js](https://github.com/cytoscape/cytoscape.js): `dist/cytoscape.min.js` | MIT; npm release `3.34.3`; tarball shasum `1503996ba0b59b901d86310a1f612e92dc464f51`; vendored asset SHA-256 `5f3b5b529546d5af1fc5628590af033b74511a5b6f789f5f4682845863228b91` | DIRECT USE / ADAPT | Self-hosted browser build closes the measured U1 pan/zoom gap without a frontend build stack. It consumes only the server-authorized node/edge projection; DOM cards remain the accessibility and deterministic fallback. No runtime CDN. |

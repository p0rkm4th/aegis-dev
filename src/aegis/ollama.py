        ...
        return json.dumps(
            {
                ...
                "answer_rule": (
                    ...
                    " Canonical grocery names or quantities do not establish prices. "
                    "Never estimate or claim a grocery total unless an explicit canonical "
                    "price/total field is supplied. An affordability amount is a budget or "
                    "limit comparison, not the grocery list's actual cost; if prices are "
                    "absent, say that the grocery total is unknown."

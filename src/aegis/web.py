...
<div class="workspace" data-view="home"><section class="conversation-panel" aria-label="Conversation with AEGIS"><div class="health-line" data-state="checking"><span><span class="status-dot" aria-hidden="true"></span><strong id="health" aria-live="polite">Checking readiness…</strong></span><details><summary>Runtime details</summary><ul id="health-details" class="muted" aria-live="polite"></ul></details></div>
<div class="view-summary"><h2 id="view-title">Chat</h2><p id="view-description">A conversation with AEGIS.</p></div>
<div class="conversation-tools"><div class="conversation-heading"><span class="eyebrow">Conversation</span><strong id="conversation-title">Current conversation</strong></div><button id="new-conversation" type="button">New conversation</button><label for="recent-conversations">Recent <select id="recent-conversations"><option value="">Current conversation</option></select></label><details id="project-context" class="project-context"><summary>Context</summary><label class="sr-only" for="chat-project">Project context</label><select id="chat-project"><option value="">None · normal AEGIS</option></select><span id="chat-project-status" class="muted" aria-live="polite"></span><button id="clear-chat-project" type="button" hidden>Clear context</button></details></div>
<h2 class="sr-only">Conversation</h2><ol id="conversation" role="log" aria-live="polite" aria-relevant="additions text"><li class="conversation-empty"><span class="empty-kicker">A quiet place to start</span><strong>What should we work on?</strong><p>Ask a question, make a plan, or tell AEGIS something worth remembering.</p><div class="empty-suggestions" aria-hidden="true"><span>Ask anything</span><span>Make a plan</span><span>Remember something</span></div></li></ol><button id="jump-latest" class="jump-latest" type="button" hidden>Jump to latest</button>
...
<div class="composer-dock" aria-label="Message composer"><div id="chat-context-handoff" class="chat-context-handoff" hidden><span class="eyebrow">From Constellation</span><span id="chat-context-label"></span><button id="clear-chat-context" type="button" aria-label="Clear Constellation context">Clear</button></div><form id="chat"><label class="sr-only" for="utterance">Message AEGIS</label><textarea id="utterance" rows="2" autocomplete="off"
...
<h2>Constellation</h2><p class="muted">AEGIS is the root of an authorized semantic map. Select a domain or capability for its conventional detail.</p><div class="constellation-legend" aria-label="Constellation map key"><span><i data-key="context"></i>Context</span><span><i data-key="attention"></i>Needs attention</span><span><i data-key="objective"></i>Objective</span><span><i data-key="relationship"></i>Relationship</span></div><div id="constellation-graph" class="constellation-graph" role="img" aria-label="Authorized semantic relationship map"></div><main id="nodes" role="group" aria-label="Authorized AEGIS constellation"><p>Loading state…</p></main>
